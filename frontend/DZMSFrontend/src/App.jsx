    ...
    <main  className="flex items-center justify-center min-h-screen">
                <div className="w-screen h-screen  flex flex-row overflow-hidden">
                    ...
                    <div id='rightSide' className={`flex justify-center transition-all w-screen duration-1000 lg:w-1/2 relative ${changeDom ? 'lg:w-5/6' : 'lg:w-1/2' }`} >
                        ...
                        :
                        <Login succesfullLogin={setSuccesfullLogin} className={`flex flex-col justify-center items-center  relative transition  duration-500 ${hideDom ? 'opacity-0' : 'opacity-100'}`} />
                        }
                    </div>
                </div>
      </main>
