  ...
  return hasUppercase && hasSpecialChar && isLongEnough;
    ...
    async function handleRegistration(event) {
        ...
        ||
         ...
         const payload = {emailValue,passwordValue};

         try{
            //Tutaj dać url do api z rejestracja
            //                            v
    ...
    return (
        ...
        <Logo className="block lg:hidden"/>
                    ...
                    <form onSubmit={handleRegistration} className="flex flex-col py-12 items-center" >
                        ...
                        <button type="submit" disabled={isRegistered.component} className="mt-10 bg-secondary-dark w-50 h-8 rounded-2xl text-white font-bold" >Login</button>
