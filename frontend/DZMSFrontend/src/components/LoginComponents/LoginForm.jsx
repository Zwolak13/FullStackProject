    ...
    return (
        ...
        <h1 className="pt-12 text-5xl font-bold">welcome<span className="text-primary-light">.</span></h1>
                    ...
                    <form onSubmit={handleLogin} className="flex flex-col py-15 items-center" >
                        ...
                        <p>Don't have an account? <button type="button" className="text-primiary-dark font-bold hover:underline" disabled={waitingResponse} onClick={onChange}>sign up</button></p>
                     </form>
